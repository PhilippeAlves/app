...
class CheckPointsControllerTest < ActionController::TestCase
  ...
  test "should create check_point" do
    assert_difference('CheckPoint.count') do
      post :create, check_point: { frequency_id: @check_point.frequency_id, hour: @check_point.hour, room_id: @check_point.room_id }
    end
  ...
  test "should update check_point" do
    patch :update, id: @check_point, check_point: { frequency_id: @check_point.frequency_id, hour: @check_point.hour, room_id: @check_point.room_id }
    assert_redirected_to check_point_path(assigns(:check_point))
  end
